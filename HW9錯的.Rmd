...
# Set threshold for dominant species (5%)
threshold <- 5   # 5%

# Find dominant species based on the condition
dominant_species <- rownames(all_species_density)[apply(all_species_density, 1, function(x) any(x >= threshold))]
...
fviz_cluster(km_res, data = dominant_scaled, geom = "point",
...
Cluster 1 was dominated by Calanus sinicus, Cluster 2 had a higher proportion of Euchaeta copepodid, and Cluster 3 was also dominated by Calanus sinicus.
